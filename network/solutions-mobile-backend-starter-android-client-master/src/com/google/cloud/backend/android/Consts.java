...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "riskserversample";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "712730003775";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "712730003775.apps.googleusercontent.com";
