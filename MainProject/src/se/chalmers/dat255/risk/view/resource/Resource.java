...
public class Resource {
	...
	/*
	 * public File neighbours =
	 * Gdx.files.internal("Gfx/neighbours.txt)").file(); public File cords =
	 * Gdx.files.internal("Gfx/Cords.txt)").file(); public File continents =
	 * Gdx.files.internal("Gfx/continents.txt)").file();
	 */
